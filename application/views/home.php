...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>V</b>RTL</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Vehicle</b>Rental</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="pages/widgets.html">
            <i class="fa fa-th"></i> <span>Add Bike</span>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> View Vehicle</a></li>
            <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> Add Vehicle </a></li>
