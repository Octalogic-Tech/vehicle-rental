...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
                        ...
                        <table id="tablebooking" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>CUSTOMER NAME</th>
    ...
    $(document).ready(function() {
        if(location.pathname=="/vehicle-rental/Display_vendor_booking")
        {
            $("#l1").addClass("active");
        }
        var table1 = $('#tablebooking').DataTable({
            responsive: true
        });
    });
