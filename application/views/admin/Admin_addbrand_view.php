        ...
        $("#addbrand").submit(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var deletebtn = '<td class="' + obj.id + '"><button id="' + obj.id + '" type="button" class="btn btn-danger" onclick="Deletebrand(' + obj.id + ')">Delete</buttton></td>';
                    var updatebtn ='<td class="'+obj.id+'"><button id="'+obj.id+'" type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal2" onclick=" Launch_updatemodal('+obj.id+')">Update</buttton></td>';
